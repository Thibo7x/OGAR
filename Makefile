...
sock: test-client.o mapFunctions.o bot_yellow.o chainedListFunctions.o bot_blue.o bot_cyan.o bot_purple.o
	$(CC) -o $@ $^ $(FLAGS)
...
bot_purple.o: bot_purple.c bot_purple.h entities.h
	$(CC) -c $^ $(FLAGS)
